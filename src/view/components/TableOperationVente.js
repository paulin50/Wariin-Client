...
import { deleteDoc, query, doc } from 'firebase/firestore';
...
const TableOperationVente = props => {
  const { currentUser, vente, caisse, client } = useContext(AuthContext);
...
export default TableOperationVente;
