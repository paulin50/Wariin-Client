...
const Sidebar = props => {
  const { currentUser, client, caisse, user } = useContext(AuthContext);
    ...
    >
      <Container fluid>
        ...
        <Collapse navbar isOpen={collapseOpen}>
          ...
          <hr className="my-3" />
          {/* Heading */}
          <h6 className="navbar-heading ">Session</h6>
          {/* Navigation */}
          <Nav className="mb-md-3" navbar>
            <NavItem>
              <NavLink className="" onClick={() => handleSignout()}>
                <i className="ni ni-button-power text-success" />
                Déconnexion
              </NavLink>
            </NavItem>
          </Nav>
